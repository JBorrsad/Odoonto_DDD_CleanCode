...
namespace Odoonto.UI.Server.Controllers.Patients
{
    ...
    public class PatientsController : BaseApiController
    {
        ...
        public PatientsController(IPatientAppService patientService, ILogger<PatientsController> logger)
            : base(logger)
        {
        ...
        {
            return await ExecuteAsync(async () => await _patientService.GetAllAsync(),
        ...
        {
            return await ExecuteAsync(async () => await _patientService.GetByIdAsync(id),
        ...
        [ProducesResponseType(500)]
        public async Task<ActionResult<Guid>> Create([FromBody] CreatePatientDto patientDto)
        {
            return await ExecuteAsync(async () =>
            {
                var patientId = await _patientService.CreateAsync(patientDto);
        ...
        [ProducesResponseType(404)]
        [ProducesResponseType(500)]
        public async Task<ActionResult> Update(Guid id, [FromBody] CreatePatientDto patientDto)
        {
            return await ExecuteAsync(async () => 
            {
        ...
        public async Task<ActionResult<IEnumerable<PatientDto>>> Search([FromQuery] string searchTerm)
        {
            return await ExecuteAsync(async () =>
            {
                ...
                return await _patientService.SearchAsync(searchTerm);
